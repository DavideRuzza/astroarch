...
- type `curl https://raw.githubusercontent.com/DavideRuzza/astroarch/stable/astroarch_build.sh > astroarch_build.sh`
...
- Edit `/boot/cmdline.txt` replacing the default content with
  ```
  root=UUID=XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX rw rootwait console=serial0,115200 console=tty1 fsck.repair=yes video=HDMI-A-1:1920x1080M@60D
  ```
